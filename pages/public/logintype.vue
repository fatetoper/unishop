		...
		<view class="footer" v-if="isAuthLoginShow && !closeThirdPartyLogin">
			...
			<view class="login-type-list">
				<button
					...
					@tap="toAuthLogin">
					<image class="image" :src="wechat">666</image>
				</button>
				<button
					:disabled="btnLoading"
					:loading="btnLoading"
...
<script>
	 ...
	 * @copyright 2019
	 */
	import { wechatH5Login, thirdPartyWechatOpenPlatform, thirdPartyApple } from '@/api/login';
	import { mpWechatLogin } from '@/api/login1';
